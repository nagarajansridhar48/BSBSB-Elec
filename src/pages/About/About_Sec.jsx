    ...
    <div className="relative px-4 sm:px-6 md:px-10 lg:px-20 py-10 sm:py-12 md:py-16">
      <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-12 md:gap-16 lg:gap-24">
        ...
        >
          ...
          {/* Replaced with list instead of paragraph */}
          <ul
            ...
            data-aos-delay="400"
          >
            <li>Life-like real-size images</li>
            <li>Excellent eye contact during conversations</li>
            <li>HD clarity audio with clear left & right separation</li>
            <li>Clear visibility of gestures & body language</li>
