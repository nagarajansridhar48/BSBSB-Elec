        ...
        <div className="w-full flex flex-col gap-15 justify-center items-center">
            ...
            >
                <p className='text-justify'>
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Deleniti mollitia officiis quam sapiente dolore reprehenderit.
                    Consequuntur debitis illum ipsa ipsam totam quis minus perferendis amet! Nemo praesentium maxime omnis corporis
                    reprehenderit explicabo odio amet? Natus qui quod aspernatur deserunt dolor, vitae provident ut incidunt odit quos eos!
                    Quisquam, autem nam.
                </p>
